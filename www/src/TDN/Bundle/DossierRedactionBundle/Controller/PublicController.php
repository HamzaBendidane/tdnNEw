...
class PublicController extends MainPublicController {
	...
	public function dossierAction ($rubrique, $slug, $id) {
		...
		$variables['TDNDocument'] = $rep_dossier->find($id);
		...
		$variables['canonical'] = $this->generateURL('DossierRedaction_page', 
			array('id' => $variables['TDNDocument']->getIdDocument(),
				  'slug' => $variables['TDNDocument']->getSlug(),
				  'theme' => $variables['TDNDocument']->getLnThematique()->getSlug(),
		...
		// Affichage de la page
		return $this->render('TDNDossierRedactionBundle:Pages:dossier.html.twig', $variables);
